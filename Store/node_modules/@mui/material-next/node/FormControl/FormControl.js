...
const FormControlRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: ({
    ...
    return (0, _extends2.default)({}, styles.root, styles[`margin${(0, _utils.unstable_capitalize)(ownerState.margin)}`], ownerState.fullWidth && styles.fullWidth);
  }
})(({
  ownerState
}) => (0, _extends2.default)({
  ...
  const [adornedStart, setAdornedStart] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        ...
        const input = (0, _utils.unstable_isMuiElement)(child, ['Select']) ? child.props.input : child;
  ...
  const [filled, setFilled] = React.useState(() => {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        ...
        if ((0, _utils2.isFilled)(child.props, true) || (0, _utils2.isFilled)(child.props.inputProps, true)) {
          initialFilled = true;
        }
      });
    }
