...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', variant, disabled && 'disabled', `size${(0, _utils.unstable_capitalize)(size)}`, `color${(0, _utils.unstable_capitalize)(color)}`, clickable && 'clickable', clickable && `clickableColor${(0, _utils.unstable_capitalize)(color)}`, onDelete && 'deletable', onDelete && `deletableColor${(0, _utils.unstable_capitalize)(color)}`, `${variant}${(0, _utils.unstable_capitalize)(color)}`],
    label: ['label', `label${(0, _utils.unstable_capitalize)(size)}`],
    avatar: ['avatar', `avatar${(0, _utils.unstable_capitalize)(size)}`, `avatarColor${(0, _utils.unstable_capitalize)(color)}`],
    icon: ['icon', `icon${(0, _utils.unstable_capitalize)(size)}`, `iconColor${(0, _utils.unstable_capitalize)(iconColor)}`],
    deleteIcon: ['deleteIcon', `deleteIcon${(0, _utils.unstable_capitalize)(size)}`, `deleteIconColor${(0, _utils.unstable_capitalize)(color)}`, `deleteIcon${(0, _utils.unstable_capitalize)(variant)}Color${(0, _utils.unstable_capitalize)(color)}`]
  };
...
const ChipRoot = (0, _styles.styled)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      ...
      [`& .${_chipClasses.default.avatar}`]: styles[`avatar${(0, _utils.unstable_capitalize)(size)}`]
    }, {
      [`& .${_chipClasses.default.avatar}`]: styles[`avatarColor${(0, _utils.unstable_capitalize)(color)}`]
    }, {
      [`& .${_chipClasses.default.icon}`]: styles.icon
    }, {
      [`& .${_chipClasses.default.icon}`]: styles[`icon${(0, _utils.unstable_capitalize)(size)}`]
    }, {
      [`& .${_chipClasses.default.icon}`]: styles[`iconColor${(0, _utils.unstable_capitalize)(iconColor)}`]
    }, {
      [`& .${_chipClasses.default.deleteIcon}`]: styles.deleteIcon
    }, {
      [`& .${_chipClasses.default.deleteIcon}`]: styles[`deleteIcon${(0, _utils.unstable_capitalize)(size)}`]
    }, {
      [`& .${_chipClasses.default.deleteIcon}`]: styles[`deleteIconColor${(0, _utils.unstable_capitalize)(color)}`]
    }, {
      [`& .${_chipClasses.default.deleteIcon}`]: styles[`deleteIcon${(0, _utils.unstable_capitalize)(variant)}Color${(0, _utils.unstable_capitalize)(color)}`]
    }, styles.root, styles[`size${(0, _utils.unstable_capitalize)(size)}`], styles[`color${(0, _utils.unstable_capitalize)(color)}`], clickable && styles.clickable, clickable && color !== 'default' && styles[`clickableColor${(0, _utils.unstable_capitalize)(color)})`], onDelete && styles.deletable, onDelete && color !== 'default' && styles[`deletableColor${(0, _utils.unstable_capitalize)(color)}`], styles[variant], styles[`${variant}${(0, _utils.unstable_capitalize)(color)}`]];
  }
})(({
  theme,
  ownerState
  ...
  border: theme.vars ? `1px solid ${theme.vars.palette.Chip.defaultBorder}` : `1px solid ${theme.palette.grey[400]}`,
...
const ChipLabel = (0, _styles.styled)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.label, styles[`label${(0, _utils.unstable_capitalize)(size)}`]];
  }
})(({
  ownerState
}) => (0, _extends2.default)({
