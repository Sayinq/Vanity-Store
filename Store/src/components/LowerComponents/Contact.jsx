...
const Contact = () => {
  return (
    <div className="flex w-screen h-fit justify-center sm:mt-0 mt-2">
        <Link to="faq">
            <Card isFooterBlurred className="w-full xl:w-full lg:w-[220px] md:w-[695px] lg:h-[200px] h-[300px] col-span-12 sm:col-span-7 cursor-default">
                ...
                <CardFooter className="absolute bg-black/40 bottom-0 z-10">
                    ...
                    <Button 
                        radius="full" 
                        size="sm" 
                        className="px-4 uppercase bg-gradient-to-r from-violet-600 to-indigo-400 text-white tracking-wide lg:tracking-normal lg:text-xs xl:max-w-fit lg:w-full"
                    >
                        Contact Us
                    </Button>
                </CardFooter>
